...
import { MessageCircle, BotMessageSquare, X, Send, Bot, User, Sparkles } from "lucide-react";
  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        {!isOpen && (
          <Link href="https://www.messenger.com/t/100086047046911" target="_blank">
            <button className="bg-blue-600 text-white rounded-full p-4 shadow-lg hover:bg-blue-700 transition-colors w-14 h-14 flex items-center justify-center">
        ...
        <button
          ...
          className={cn(
            "w-14 h-14 rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-300 group",
            isOpen 
        ...
        >
          {isOpen ? (
            ...
            <div className="relative">
              <BotMessageSquare className="w-6 h-6 text-white group-hover:scale-110 transition-transform" />
      ...
      <div 
        className={cn(
          "fixed bottom-24 right-6 bg-white/80 backdrop-blur-xl border border-slate-200/60 shadow-2xl rounded-2xl w-[350px] sm:w-[400px] overflow-hidden flex flex-col transition-all duration-300 transform origin-bottom-right z-50",
